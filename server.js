...
app.post("/chat", async (req, res) => {
  ...
  // ============================================================
// ⭐ SALUDO ESPECIAL AL SALIR DEL MODO BUSINESS
// ============================================================
if (message === "__business_exit_greeting__") {

  const farewell = `
I hope your Business English simulation went well.
We’re now back to normal English practice.
